...
public class UpdateAppointmentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        passedCustomer = CustomerOBJ.getCustomer(passedAppt.getApptCustomerId());
        ...
        passedUser = UserOBJ.getUser(passedAppt.getApptUserId());
        ...
        passedContact = ContactOBJ.getContact(passedAppt.getApptContactId());
    ...
    public void UpdateAppointment(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (title.isEmpty() | description.isEmpty() | location.isEmpty() | type.isEmpty()
                ...
                AppointmentOBJ.updateAppointment(a);
     ...
     */
    public void CancelUpdateAppointment(ActionEvent actionEvent) throws IOException {
